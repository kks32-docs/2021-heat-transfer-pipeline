...
\Cref{tab:mat} presents the thermal properties of the fluid, soil, and cables. We simulate the heat transfer of pipeline carrying water. The thermal conductivity of soil depends on its water content~\cite{young2001utilizing}. The bulk thermal conductivity and bulk specific heat of the porous media are calculated based on the volume fraction of fluid and solids:
\begin{align}
